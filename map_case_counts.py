...
for td in dict_date_range:
    ...
    if tdd>=latestDate:    
        ...
        fig.text( 0.205,0.93,'Source: Public Health England', fontsize=8)
        ...
        fig_name = "img_casecounts/" + td + '_utla_covid_cases.png'
